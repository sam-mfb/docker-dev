...
HOST_PORT_RANGE="3010-3019"
CONTAINER_PORT_RANGE="3010-3019"
HOSTNAME="sam-dev"

# Export for docker-compose
export IMAGE_TAG CONTAINER_NAME HOST_PORTS CONTAINER_PORTS HOST_PORT_RANGE CONTAINER_PORT_RANGE HOSTNAME
